...
/apps/smt_tools/decoders/mosesdecoder/scripts/training/train-model.perl --root-dir data/models/random_model_legal/ --f es --e en --corpus /results/random.legal -external-bin-dir /apps/smt_tools/alignment/mgizapp-0.7.3/manual-compile -mgiza -mgiza-cpus 48 -lm 0:3:/home/avisser/data/lm/random.legal.en.lm
/apps/smt_tools/decoders/mosesdecoder/scripts/training/train-model.perl --root-dir data/models/random_model_software/ --f es --e en --corpus /results/random.software -external-bin-dir /apps/smt_tools/alignment/mgizapp-0.7.3/manual-compile -mgiza -mgiza-cpus 48 -lm 0:3:/home/avisser/data/lm/random.software.en.lm

/apps/smt_tools/decoders/mosesdecoder/scripts/training/train-model.perl --root-dir data/models/svm_model_legal/ --f es --e en --corpus /results/svm_results.legal -external-bin-dir /apps/smt_tools/alignment/mgizapp-0.7.3/manual-compile -mgiza -mgiza-cpus 48 -lm 0:3:/home/avisser/data/lm/svm_results.legal.en.lm
/apps/smt_tools/decoders/mosesdecoder/scripts/training/train-model.perl --root-dir data/models/svm_model_software/ --f es --e en --corpus /results/svm_results.software -external-bin-dir /apps/smt_tools/alignment/mgizapp-0.7.3/manual-compile -mgiza -mgiza-cpus 48 -lm 0:3:/home/avisser/data/lm/svm_results.software.en.lm

/apps/smt_tools/decoders/mosesdecoder/scripts/training/train-model.perl --root-dir data/models/wbs_model_legal/ --f es --e en --corpus /results/wbs_results.legal -external-bin-dir /apps/smt_tools/alignment/mgizapp-0.7.3/manual-compile -mgiza -mgiza-cpus 48 -lm 0:3:/home/avisser/data/lm/wbs_results.legal.en.lm
/apps/smt_tools/decoders/mosesdecoder/scripts/training/train-model.perl --root-dir data/models/wbs_model_software/ --f es --e en --corpus /results/wbs_results.software -external-bin-dir /apps/smt_tools/alignment/mgizapp-0.7.3/manual-compile -mgiza -mgiza-cpus 48 -lm 0:3:/home/avisser/data/lm/wbs_results.software.en.lm
